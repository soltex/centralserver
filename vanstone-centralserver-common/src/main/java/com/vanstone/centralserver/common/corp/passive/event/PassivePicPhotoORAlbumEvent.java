 ...
 *
 */
public class PassivePicPhotoORAlbumEvent extends AbstractPassiveEvent {

	private String eventKey;
	private int count;
	private List<String> picMd5Sums = new ArrayList<String>();

	public PassivePicPhotoORAlbumEvent() {
		super(CorpWeixinEvent.PIC_PHOTO_OR_ALBUM);
	}
	...
	public void addPicMd5Sums(Collection<String> items) {
		this.picMd5Sums.addAll(items);
	}
