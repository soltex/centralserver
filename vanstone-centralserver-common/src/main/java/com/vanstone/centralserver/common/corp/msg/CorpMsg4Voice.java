...
public class CorpMsg4Voice extends AbstractCorpMsg {
	 ...
	 * @param safe
	 */
	public CorpMsg4Voice(ICorpApp agentid, boolean safe) {
		super(CorpMsgType.Voice ,agentid, safe, true, null, null, null);
	}
	 ...
	 * @param tagids
	 */
	public CorpMsg4Voice(ICorpApp agentid, boolean safe, Collection<String> touserids, Collection<String> topartyids, Collection<String> tagids) {
		super(CorpMsgType.Voice, agentid, safe, false, touserids, topartyids, tagids);
	}
	...
	public String toJson() {
		...
		voiceMap.put("voice", this.mediaID);
